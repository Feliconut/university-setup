...
LOGSEQ_ROOT = Path(r'C:\Users\86186\Documents\logseq')
LOGSEQ_PROJ_NAME = 'Feliconut'
LOGSEQ_PROJ = LOGSEQ_ROOT / LOGSEQ_PROJ_NAME
LOGSEQ_PAGES = LOGSEQ_PROJ / 'pages'

VIMTEX_ROOT = Path(r'C:\Users\86186\Documents\git-repos\Notes\Purdue')
